...
export const RECORD_SCORES_REQUEST = 'RECORD_SCORES_REQUEST'
export const RECORD_SCORES_SUCCESS = 'RECORD_SCORES_SUCCESS'
export const RECORD_SCORES_ERROR = 'RECORD_SCORES_ERROR'
